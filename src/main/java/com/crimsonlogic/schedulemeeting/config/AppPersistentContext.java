...
@ComponentScan("com.crimsonlogic.schedulemeeting")
@EnableJpaRepositories(basePackages="com.crimsonlogic.schedulemeeting.repository")
public class AppPersistentContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		lcmfb.setPackagesToScan(new String[] {"com.crimsonlogic.schedulemeeting.entity"});
